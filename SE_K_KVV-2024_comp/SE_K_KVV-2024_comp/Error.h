...
#define ERROR_THROW_IN(id, l, c, text) Error::geterrorin(id, l, c, text); //l - строка, c - колонка
#define ERROR_THROW_LEX(id, l, text, t) Error::geterrorin(id, l, text, t);
#define ERROR_ENTRY(id, m) {id, m, {-1, -1, (unsigned char*)""}} //элемент таблицы ошибок
